...
#include "../hockey/HockeyGame/messenger.h"
...
QT_MOC_LITERAL(1, 10, 16), // "sig_newMessageIn"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4) // "type"

    },
    "Messenger\0sig_newMessageIn\0\0type"
};
...
void Messenger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_newMessageIn((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Messenger::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Messenger::sig_newMessageIn)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Messenger::sig_newMessageIn(int _t1)
{
